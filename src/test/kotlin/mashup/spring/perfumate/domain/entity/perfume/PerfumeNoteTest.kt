...
import mashup.spring.perfumate.repository.perfume.NoteRepository
import mashup.spring.perfumate.repository.perfume.PerfumeNoteRepository
...
class PerfumeNoteTest @Autowired constructor(
    ...
    fun get_note_from_perfume() {
        ...
        assertEquals(1, findPerfume.notes.size)
        assertEquals("steel", findPerfume.notes[0].note.name)
    }
}